<div align="center">
  ...
  **A dead-simple, dark-mode document editor for Windows.**
  ...
  [![Latest release](https://img.shields.io/github/v/release/MrBeanTheOne/DocOpen?label=release&color=4c9aff)](https://github.com/MrBeanTheOne/DocOpen/releases/latest)
  [![License](https://img.shields.io/badge/license-All%20rights%20reserved-lightgrey)](LICENSE)
  [![Platform](https://img.shields.io/badge/platform-Windows-0078d4)](#install--run)
...
- 🗂️ **Tabs** — open several documents at once; `Ctrl+Tab` / `Ctrl+Shift+Tab` to cycle, `Ctrl+W` to close.
...
Grab the installer from the [latest release](https://github.com/MrBeanTheOne/DocOpen/releases/latest), or run from source:
...
Copyright © 2026 Retile. **All rights reserved** — see [LICENSE](LICENSE). The source is public for viewing and reference; official release builds are free to download and use personally.

Bundled open-source components are listed in [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md).
